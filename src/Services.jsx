      ...
      <div className="bg-white max-w-6xl mx-auto rounded-xl shadow-xl p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="flex-1 border border-gray-300 hover:border-green-500 p-4 rounded-lg shadow-md hover:scale-110 transition-transform duration-300">
            ...
            <p className="text-gray-700 text-sm text-center">
              Building secure and scalable APIs using Node.js and Express.js. Managing data with MongoDB and implementing authentication (JWT).
            </p>
          </div>
          ...
          <div className="flex-1 border border-gray-300 hover:border-green-500 p-4 rounded-lg shadow-md hover:scale-110 transition-transform duration-300">
            ...
            <p className="text-gray-700 text-sm text-center">
              Building complete MERN stack apps. Seamlessly integrating frontend & backend. Deploying on (Vercel, Firebase).
            </p>
          </div>
        </div>
      </div>
